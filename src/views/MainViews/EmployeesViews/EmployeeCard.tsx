...
import { PositionItem } from '../SettingsViews/Position/PositionItem';
...
const styles = StyleSheet.create({
  ...
  export function EmployeeCardScreen({navigation, route}:any)
  {
    ...
    const [PositionsArray, setPositionsArray] = useState(Object);

    const [modalPositionVisible, setModalPositionVisible] = useState(false);

    useEffect(()=>{
      setPositionsArray(getFreePositions());
    },[])
    ...
    return(
        <View style={styles.container}>
          ...
          <View style={{justifyContent: 'center', alignItems: 'center', flexDirection: 'row'}}>
              ...
              <TouchableOpacity onPress={()=>setModalPositionVisible(true)} style={{flex:3, flexDirection: 'row'}}>
